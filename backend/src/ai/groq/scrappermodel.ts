...
export async function scrapperModel(
  user_ptompt: string,
  webpage_data: string,
  model_id: string,
  ...
  Understand the user requiremnts carefully and go through the data (it can be either html, plain text or a json) and on the basis of user requirements find out the meaningful data and output everything in json format.
  output format = {
    scrapped_data : {}
  }
  `;
